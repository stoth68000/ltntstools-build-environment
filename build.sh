...
if [ "$1" == "" ]; then
	...
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.37.0
	LIBLTNTSTOOLS_TAG=524a8947ba5560f4f5e3ff2221c85eb0e6224531
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	BUILD_OPT_SHARED=yes
	...
	DEP_LIBDVBPSI_TAG=d2a81c20a7704676048111b4f7ab24b95a904008
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.38.5
	LIBLTNTSTOOLS_TAG=f2f2c36199f78a9491c340183e07000a840894d4
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	BUILD_OPT_SHARED=yes
	...
	LIBLTNTSTOOLS_TAG=6ff1b084b28aacf46806cb9e9bc355b99bad1326
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	BUILD_OPT_SHARED=yes
	...
	DEP_LIBDVBPSI_TAG=d2a81c20a7704676048111b4f7ab24b95a904008
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.39.4
	LIBLTNTSTOOLS_TAG=18bd3348887890c027b449d33d981d4324e53fd3
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	BUILD_OPT_SHARED=yes
	...
	DEP_LIBDVBPSI_TAG=d2a81c20a7704676048111b4f7ab24b95a904008
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.39.8
	LIBLTNTSTOOLS_TAG=e3312e004fefcbe2e9a3c752b87bffb6fa27cc89
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	BUILD_OPT_SHARED=yes
	...
	DEP_LIBDVBPSI_TAG=d2a81c20a7704676048111b4f7ab24b95a904008
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.39.9
	LIBLTNTSTOOLS_TAG=87995a3074cc704e8731ace66baf208f99cbbfc8
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	BUILD_OPT_SHARED=yes
	BUILD_OPT_SRT=--enable-debug=2
	BUILD_OPT_LIBDVBPSI=--enable-debug
elif [ "$1" == "v1.39.11" ]; then
	DEP_BITSTREAM_TAG=20ce4345061499abc0389e9cd837665a62ad6add
	DEP_LIBDVBPSI_TAG=d2a81c20a7704676048111b4f7ab24b95a904008
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.39.11
	LIBLTNTSTOOLS_TAG=87995a3074cc704e8731ace66baf208f99cbbfc8
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	...
	BUILD_OPT_SRT=--enable-debug=2
	BUILD_OPT_LIBDVBPSI=--enable-debug
elif [ "$1" == "v1.39.12" ]; then
	DEP_BITSTREAM_TAG=20ce4345061499abc0389e9cd837665a62ad6add
	DEP_LIBDVBPSI_TAG=d2a81c20a7704676048111b4f7ab24b95a904008
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.39.12
	LIBLTNTSTOOLS_TAG=87995a3074cc704e8731ace66baf208f99cbbfc8
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	...
	DEP_FFMPEG_TAG=release/4.4
	LTNTSTOOLS_TAG=v1.38.6
	LIBLTNTSTOOLS_TAG=dafdf269e1ba69ddff4c827ecdf0657743628202
	LIBKLSCTE35_TAG=vid.obe.1.4.0
	LIBKLVANC_TAG=vid.obe.1.12.0
	LIBNTT_TAG=9b4365fc44ce1edbc94325e4cddeadc504802ed9
	BUILD_OPT_SHARED=no
